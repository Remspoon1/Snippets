...
export default function Post({
  ...
  const handleDeletePost = async () => {
    ...
    toast.success("your post hase been deleted")
  ...
  return (
    ...
    {confirmation &&
      <Modal.Dialog>
        ...
        <Modal.Footer>
          <Button variant="secondary" onClick={handleDeletePost}>Delete</Button>
          <Button variant="primary" onClick={() => setConfirmation(false)}>Cancel</Button>
        </Modal.Footer>
      </Modal.Dialog>}
        ...
        <Media className='mb-n2 w-100'>
          ...
          <Media.Body className='w-50'>
            <div className='row d-flex align-items-center'>
              <span className='text-muted mr-1 username'><Link to={`/u/${author.username}`}>@{author.username}</Link></span>
